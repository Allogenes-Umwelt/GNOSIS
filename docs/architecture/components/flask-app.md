...
C4Component
    ...
    Container_Boundary(flask, "Aplicación Flask") {
        ...
        Component(bp_auto, "Blueprint autogenes", "rutas/autogenes.py", "82 rutas: landing, grafo, ingesta, QUALIA, CONCILIA, VALIDACIÓN, SINAPSIS, NOMOS, CRONOS, CONTROL, disposiciones, expediente, síntesis, export.")
        ...
        Component(shell, "Sessions/Admin/Chat/Errores", "app.py", "30 rutas: gestión de sesiones, config LLM, proxy de chat, panel de errores.")
    }
